...
\end{tabular}
\caption{Dependence of the sign of $\Delta$ from Eqn.\ \ref{eqn:delta} on $B$. (a) $\Delta$ is calculated as described in the text; (b) The dependence of $\Delta$ on library length $L$ is shown for points $(A,B) = (2.6,2.6)$ and $(A,B)=(3.0,2.6)$ marked in (a) with white circles.}
\label{fig:linearex1}
\end{figure}
