...
\section{Conclusion}
The examples presented in this article have shown that PAI can be used to better indicate ``driving'' relationships that agree with intuition.  PAI may be useful exploratory data analysis.  For example, PAI may help guide the development of physical causality models (e.g.\ by suggesting future experiments) in scenarios involving a large collection of simultaneous time series measurements of different variables in a system but no {\em a priori} notions of causality in the system.
