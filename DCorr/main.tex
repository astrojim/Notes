...
(b)
\end{tabular}
\caption{The sign of $\Delta$, and thus the CCM causality, depends on $A$ and $B$. (a) $\Delta$ calculated as described in the text; (b) Two color version of (a) where black indicates $\Delta>0$ and white indicates $\Delta<0$.}
\label{fig:linearex1}
\end{figure}
