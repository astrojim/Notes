...
\end{tabular}
\caption{These times series data pairs are expected to have the causal relationships of $X\rightarrow Y$ for each pair of subplots [(a),(b)] and [(c),(d)], where $X$ or $Y$ is marked in parenthesis for each time series.}
\label{fig:empdata}
\end{figure*}
