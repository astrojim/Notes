...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.40]{NoisyResponseExample_X.eps} & \includegraphics[scale=0.40]{NoisyResponseExample_Y.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[An instance of Eqn.\ \ref{eqn:IReqn}]{An instance of Eqn.\ \ref{eqn:IReqn} for $L=500$, $A=0.1$, and $B=0.4$.}
\label{fig:IRxyplot}
\end{figure}
\end{center}
\vspace*{\fill}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{NoisyResponseExample_Xhist.eps} & \includegraphics[scale=0.4]{NoisyResponseExample_Yhist.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[Histograms of the instance of Eqn.\ \ref{eqn:IReqn}]{Histograms of the instance of Eqn.\ \ref{eqn:IReqn} shown in Figure \ref{fig:IRxyplot}.}
\label{fig:IRxyhist}
\end{figure}
\end{center}
\vspace*{\fill}
...
\end{center}
\caption[Lagged cross-correlation differences]{Lagged cross-correlation differences, $\Delta_l$, and weighted mean observed leanings, $\langle\lambda_l\rangle$, (given an $l$-standard cause-effect assignment with $\pm\delta_x = 0.5$ and $\pm\delta_y=1$) for the instances of Eqn.\ \ref{eqn:IReqn} shown in Figure \ref{fig:IRxyplot} given lags of $l=1,2,\ldots,6$.}
...
\begin{figure}[h]
\begin{tabular}{ccc}
\includegraphics[scale=0.45]{NoisyResponseExample_lagplotXYl1.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotXYl2.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotXYl3.eps} \\
(a) $l = 1$ & (b) $l = 2$ & (c) $l = 3$ \\
\includegraphics[scale=0.45]{NoisyResponseExample_lagplotXYl4.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotXYl5.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotXYl6.eps} \\
(d) $l = 4$ & (e) $l = 5$ & (f) $l = 6$
\end{tabular}
\caption[Lagged cross-correlation plots]{Lagged cross-correlation plots, $(x_{t-l},y_t)$, for the instance of Eqn.\ \ref{eqn:IReqn} shown in Figure \ref{fig:IRxyplot} given lags of $l=1,2,\ldots,6$.}
...
\begin{figure}[h]
\begin{tabular}{ccc}
\includegraphics[scale=0.45]{NoisyResponseExample_lagplotYXl1.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotYXl2.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotYXl3.eps} \\
(a) $l = 1$ & (b) $l = 2$ & (c) $l = 3$ \\
\includegraphics[scale=0.45]{NoisyResponseExample_lagplotYXl4.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotYXl5.eps} & \includegraphics[scale=0.45]{NoisyResponseExample_lagplotYXl6.eps} \\
(d) $l = 4$ & (e) $l = 5$ & (f) $l = 6$
\end{tabular}
\caption[Lagged cross-correlation plots]{Lagged cross-correlation plots, $(y_{t-l},x_t)$, for the instance of Eqn.\ \ref{eqn:IReqn} shown in Figure \ref{fig:IRxyplot} given lags of $l=1,2,\ldots,6$.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.55]{NoisyResponseExample_leandifftoll1.eps} & \includegraphics[scale=0.55]{NoisyResponseExample_leandifftoll5.eps} \\
(a) $l=1$ & (b) $l=5$
\end{tabular}
\caption[Leaning calculations for the instance of Eqn.\ \ref{eqn:IReqn}]{Leaning calculations for the instance of Eqn.\ \ref{eqn:IReqn} shown in Figure \ref{fig:IRxyplot} using the $l$-standard assignment for $l=1$ and $l=5$ and tolerance domains defined as $\pm\delta_x\in[0,1]$ and $\pm\delta_y\in[0,1]$ in steps of 0.05.}
...
\end{center}
\caption[ECA guesses for different instances of Eqn.\ \ref{eqn:IReqn}]{ECA guesses for different instances of Eqn.\ \ref{eqn:IReqn} evaluated with $A\in[0,1]$ and $B\in[0,1]$ in steps on 0.05 and $L=500$ with $l$-standard assignment leaning calculations and lagged cross-correlation differences given $l=1,2,\ldots,6$ and leaning tolerance domains calculated as $\pm\delta_x=f(\max(\mathbf{X})-\min(\mathbf{X}))$ and $\pm\delta_y=f(\max(\mathbf{Y})-\min(\mathbf{Y}))$ with $f=1/4$.  The black indicates $|g|^2=0\Rightarrow\mathbf{X}\rightarrow\mathbf{Y}$, as expected, and the white indicates $|g|^2 \neq 0$.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{NoisyCyclicResponseExample_X.eps} & \includegraphics[scale=0.4]{NoisyCyclicResponseExample_Y.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[An instance of Eqn.\ \ref{eqn:cyceqn}]{An instance of Eqn.\ \ref{eqn:cyceqn} for $L=500$, $A=0.1$, and $B=0.4$.}
\label{fig:cycxyplot}
\end{figure}
\end{center}
\vspace*{\fill}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{NoisyCyclicResponseExample_Xhist.eps} & \includegraphics[scale=0.4]{NoisyCyclicResponseExample_Yhist.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[Histograms of the instance of Eqn.\ \ref{eqn:cyceqn}]{Histograms of the instance of Eqn.\ \ref{eqn:cyceqn} shown in Figure \ref{fig:cycxyplot}.}
\label{fig:cycxyhist}
\end{figure}
\end{center}
\vspace*{\fill}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{NoisyCyclicResponseExample_autocorrX.eps} & \includegraphics[scale=0.4]{NoisyCyclicResponseExample_autocorrY.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
...
\end{center}
\caption[Lagged cross-correlation differences]{Lagged cross-correlation differences, $\Delta_l$, and weighted mean observed leanings, $\langle\lambda_l\rangle$, (given an $l$-standard cause-effect assignment with $(1/4)$-width tolerance domains) for the instances of Eqn.\ \ref{eqn:cyceqn} shown in Figure \ref{fig:cycxyplot} given lags of $l=1,2,\ldots,20$.}
...
\end{center}
\caption[ECA guesses for different instances of Eqn.\ \ref{eqn:cyceqn}]{ECA guesses for different instances of Eqn.\ \ref{eqn:cyceqn} evaluated with $A\in[0,1]$ and $B\in[0,1]$ in steps on 0.05 and $L=250$ with $l$-standard assignment leaning calculations and lagged cross-correlation differences given $l=1,2,\ldots,20$ and $(1/4)$-width tolerance domains.  The black indicates $|g|^2=0\Rightarrow\mathbf{X}\rightarrow\mathbf{Y}$, as expected, and the white indicates $|g|^2 \neq 0$.}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.35]{IRCircuitResponseExampleL10R5_Y.eps} &
\includegraphics[scale=0.35]{IRCircuitResponseExampleL5R20_Y.eps} \\
...
\begin{center}
\begin{tabular}{c}
\includegraphics[scale=0.35]{IRCircuitResponseExampleL10R5_Yhist_an.eps} \\
(a) $\mathbf{I}$ ($L=10$ H and $R=5$ $\Omega$, analytical solution) \\ 
\includegraphics[scale=0.35]{IRCircuitResponseExampleL10R5_Yhist_num.eps} \\
(b) $\mathbf{I}$ ($L=10$ H and $R=5$ $\Omega$, numerical solution)\\
\includegraphics[scale=0.35]{IRCircuitResponseExampleL5R20_Yhist_an.eps} \\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.4]{IRCircuitResponseExampleL10R5_autocorrY.eps} &
\includegraphics[scale=0.4]{IRCircuitResponseExampleL5R20_autocorrY.eps} \\
(a) $\mathbf{I}$ ($L=10$ H and $R=5$ $\Omega$) & (b) $\mathbf{I}$ ($L=5$ H and $R=20$ $\Omega$)\\
\includegraphics[scale=0.4]{IRCircuitResponseExampleL10R5_autocorrX.eps} \\
(c) $\mathbf{V}$
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.3]{IRCircuitResponseExampleL10R5_LandLCC_an.eps} &
\includegraphics[scale=0.3]{IRCircuitResponseExampleL10R5_LandLCC_num.eps} \\
(a) $L=10$ H and $R=5$ $\Omega$ {\footnotesize (analytical)} & (b) $L=10$ H and $R=5$ $\Omega$ {\footnotesize (numerical)}\\
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{NonlinearResponseExample_X.eps} & \includegraphics[scale=0.4]{NonlinearResponseExample_Y.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[An instance of Eqn.\ \ref{eqn:nonlinearEX}]{An instance of Eqn.\ \ref{eqn:nonlinearEX} for $A=0.1$, $B=0.3$, $C=0.4$, $D=0.5$, $a=b=1$, and $c=0$.}
\label{fig:nonxyplot}
\end{figure}
\end{center}
\vspace*{\fill}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{NonlinearResponseExample_autocorrX.eps} & \includegraphics[scale=0.4]{NonlinearResponseExample_autocorrY.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
...
\end{center}
\caption[Lagged cross-correlation differences]{Lagged cross-correlation differences, $\Delta_l$, and weighted mean observed leanings, $\langle\lambda_l\rangle$, (given an $l$-standard cause-effect assignment with $(1/4)$-width tolerance domains) for the instances of Eqn.\ \ref{eqn:nonlinearEX} shown in Figure \ref{fig:nonxyplot} given lags of $l=1,2,\ldots,15$.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{CoupLogMapExample_X.eps} & \includegraphics[scale=0.4]{CoupLogMapExample_Y.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[An instance of Eqn.\ \ref{eqn:2pop}]{An instance of Eqn.\ \ref{eqn:2pop} for $L=500$, $\beta_{xy} = 0.5$, $\beta_{yx} = 1.5$, $r_x = 3.8$, and $r_y = 3.2$ with initial conditions $x_0 = y_0 = 0.4$.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{CoupLogMapExample_Xhist.eps} & \includegraphics[scale=0.4]{CoupLogMapExample_Yhist.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[Histograms of the instance of Eqn.\ \ref{eqn:2pop} ]{Histograms of the instance of Eqn.\ \ref{eqn:2pop} shown in Figure \ref{fig:2popxyplot}.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{CoupLogMapExample_autocorrX.eps} & \includegraphics[scale=0.4]{CoupLogMapExample_autocorrY.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
...
\end{center}
\caption[Lagged cross-correlation differences]{Lagged cross-correlation differences, $\Delta_l$, and weighted mean observed leanings, $\langle\lambda_l\rangle$, (given an $l$-standard cause-effect assignment with $(1/4)$-width tolerance domains) for the instances of Eqn.\ \ref{eqn:cyceqn} shown in Figure \ref{fig:2popxyplot} given lags of $l=1,2,\ldots,4$.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.35]{NoisyMultiResponseExample_X.eps} & \includegraphics[scale=0.35]{NoisyMultiResponseExample_Y.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$ \\
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.35]{NoisyMultiResponseExample_Xhist.eps} & \includegraphics[scale=0.35]{NoisyMultiResponseExample_Yhist.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$ \\
\includegraphics[scale=0.35]{NoisyMultiResponseExample_Z1hist.eps} & \includegraphics[scale=0.35]{NoisyMultiResponseExample_Z2hist.eps} \\
(c) $\mathbf{Z} = \{z_t\}$ (case 1)& (d) $\mathbf{Z} = \{z_t^\prime\}$ (case 2)\\
\includegraphics[scale=0.35]{NoisyMultiResponseExample_Z3hist.eps} & \\
(e) $\mathbf{Z} = \{z_t^{\prime\prime}\}$ (case 3)& 
\end{tabular}
\caption[Histograms of the instance of Eqn.\ \ref{eqn:3var}]{Histograms of the instance of Eqn.\ \ref{eqn:3var} shown in Figure \ref{fig:3varxyplot}.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.35]{NoisyMultiResponseExample_autocorrX.eps} & \includegraphics[scale=0.35]{NoisyMultiResponseExample_autocorrY.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$ \\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[scale=0.35]{NoisyMultiResponseExample_LandLCC_XY.eps} & \includegraphics[scale=0.35]{NoisyMultiResponseExample_LandLCC_XZ1.eps} \\
(a) $(\mathbf{X},\mathbf{Y})$ & (b) $(\mathbf{X},\mathbf{Z})$ (case 1)\\
\includegraphics[scale=0.35]{NoisyMultiResponseExample_LandLCC_XZ2.eps} & \includegraphics[scale=0.35]{NoisyMultiResponseExample_LandLCC_XZ3.eps} \\
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{WhistlerDailyExample_X.eps} & \includegraphics[scale=0.4]{WhistlerDailyExample_Y.eps} \\
(a) mean temperature $\mathbf{X}$ & (b) daily snowfall $\mathbf{Y}$
\end{tabular}
\caption[Daily snowfall and mean temperature]{Daily snowfall (the expected response) and mean temperature (the expected driver) from July 1 1972 to December 31 2009 at Whistler, BC, Canada (Latitude: 50$^\circ$04$^\prime$04.000$^{\prime\prime}$ N, Longitude: 122$^\circ$56$^\prime$50.000$^{\prime\prime}$ W, Elevation: 1835.00 meters).}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{WhistlerDailyExample_Xhist.eps} & \includegraphics[scale=0.4]{WhistlerDailyExample_Yhist.eps} \\
(a) mean temperature $\mathbf{X}$ & (b) daily snowfall $\mathbf{Y}$
\end{tabular}
\caption[Histograms of the data]{Histograms of the data shown in Figure \ref{fig:WhistSnowxyplot}.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{WhistlerDailyExample_autocorrX.eps} & \includegraphics[scale=0.4]{WhistlerDailyExample_autocorrY.eps} \\
(a) $\mathbf{X}$ & (b) $\mathbf{Y}$
\end{tabular}
\caption[Autocorrelations of the data ]{Autocorrelations of the data shown in Figure \ref{fig:WhistSnowxyplot} given lags of $l=1,2,\ldots,50$.  The autocorrelations are $|r(b_{t-l},b_t)|^2$ where $r(\cdot)$ is the Pearson correlation coefficient between the lagged $l$ series $\{b_{t-l}\}$ and the time series $\{b_{t}\}$.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_Bzhourly.eps} & \includegraphics[scale=0.4]{SolarExample_Dhourly.eps} \\
(a) $\mathbf{B}$ & (b) $\mathbf{D}$
\end{tabular}
\caption[Hourly measurements]{Hourly measurements of the magnetic field component, $B_z$, and disturbance storm time index, $D_{st}$ from the beginning of January 1, 1963 until the end of December 31, 2012, taken from the NASA OMNI data set.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_Bzhourlyhist.eps} & \includegraphics[scale=0.4]{SolarExample_Dhourlyhist.eps} \\
(a) $\mathbf{B}$ & (b) $\mathbf{D}$
\end{tabular}
\caption[Histograms of the data]{Histograms of the data shown in Figure \ref{fig:BzDstHOURLYxyplot}.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_Bzhourlyrec.eps} & \includegraphics[scale=0.4]{SolarExample_Bzhourlyrechist.eps} \\
(a) $\mathbf{B}_r$ (time series) & (b) $\mathbf{B}_r$ (histogram)
\end{tabular}
\caption[Hourly measurements of the rectified magnetic field]{Hourly measurements of the rectified magnetic field, $B_z^\prime$ from the beginning of January 1, 1963 until the end of December 31, 2012, and the 1000-bin histogram of that data.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_Bzdaily.eps} & \includegraphics[scale=0.4]{SolarExample_Ddaily.eps} \\
(a) $\bar{\mathbf{B}}$ & (b) $\bar{\mathbf{D}}$
\end{tabular}
\caption[Daily averages of the hourly measurements]{Daily averages of the hourly measurements of the magnetic field, $B_z$, and disturbance storm time index, $D_{st}$ from the beginning of January 1, 1997 until the end of December 31, 2001, taken from the NASA OMNI data set.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_Bzdailyhist.eps} & \includegraphics[scale=0.4]{SolarExample_Ddailyhist.eps} \\
(a) $\bar{\mathbf{B}}$ & (b) $\bar{\mathbf{D}}$
\end{tabular}
\caption[Histograms of the data]{Histograms of the data shown in Figure \ref{fig:BzDstDAILYxyplot}.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_Bzdailyrec.eps} & \includegraphics[scale=0.4]{SolarExample_Bzdailyrechist.eps} \\
(a) $\bar{\mathbf{B}}_r$ (time series) & (b) $\mathbf{\mathbf{B}}_r$ (histogram)
\end{tabular}
\caption[Daily averages of the hourly measurements]{Daily averages of the hourly measurements of the rectified magnetic field, $B_z^\prime$ from the beginning of January 1, 1997 until the end of December 31, 2001, and the 100-bin histogram of that data.}
...
\begin{figure}[h]
\begin{tabular}{cc}
\includegraphics[scale=0.4]{SolarExample_autocorrBzdaily.eps} & \includegraphics[scale=0.4]{SolarExample_autocorrDdaily.eps} \\
(a) $\bar{\mathbf{B}}$ & (b) $\bar{\mathbf{D}}$
\end{tabular}
\caption[Autocorrelations of the data]{Autocorrelations of the data shown in Figure \ref{fig:BzDstDAILYxyplot} given lags of $l=1,2,\ldots,100$.  The autocorrelations are $|r(b_{t-l},b_t)|^2$ where $r(\cdot)$ is the Pearson correlation coefficient between the lagged $l$ series $\{b_{t-l}\}$ and the time series $\{b_{t}\}$.}
